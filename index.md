...
- __Neuro Instrumentation__
    - Multichannel electrophysiology, functional imaging, optogenetics
    - Real-time/closed-loop hardware and software design
    - Digital and analog electronics design
    - Circuit simulation (SPICE, ModelSim)
    - PCB layout (EAGLE, KiCAD)
    - Mechanical CAD (Solidworks)

- __Experimental Neuroscience__
    - Patch/multichannel electrophysiology
...
- __Software Development:__
    - C, C++, C#, Python, MATLAB/Octave, among others. Assembly-level programming.
    - Instrumentation API development

- __Digital Logic Design__
    - VHDL, verilog
    - Communication protocol development, FPGA development

- __Mathematical Techniques:__ Linear and nonlinear systems, controls, chaos theory, information theory, random processes

- __Developement & Documentation:__ LaTeX, Markdown, Pandoc, reStructedText, Sphinx, git, svn.
-->
...
Linking connectivity and coding in recurrent cortical networks using continuously
varying optical stimulation.
-->
